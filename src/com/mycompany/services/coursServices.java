...
public class coursServices {
    ...
    public void ajoutCours(cours cours) {
        ...
        String url = statics.BASE_URL + "/ajout?nom_cours=" + cours.getNom_cours() + "&activite=" + cours.getActivite() + "&date_cours=" + cours.getDatecours() + "&image=" + cours.getImage(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
...
// Insert data into ArrayList result
    ...
    public boolean modifierCours(cours cours) {
        String url = statics.BASE_URL + "/update/" + cours.getId() + "&nom_cours=" + cours.getNom_cours() + "&activite=" + cours.getActivite();
